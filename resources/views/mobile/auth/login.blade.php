...
<head>
    ...
    <title>Mark Kost | Login</title>
    <meta content="Mark Kost App" name="description" />
    <meta content="Mark Kost" name="author" />
...
<body class=" menu-full  isfullscreen  html" data-header="light" data-footer="light" data-header_align="app"
    ...
    <nav class="fix_topscroll logo_on_fixed  topbar navigation">
        <div class="nav-wrapper container">
            <a id="logo-container" href="{{ asset('/') }}" class=" brand-logo "><svg
                    xmlns="http://www.w3.org/2000/svg" width="400.000000pt" height="400.000000pt"
        ...
        <div class="container login-area">
            <div class="section">
                <div class="text-center mb-5">
                    <img src="/logo.png" width="150px;" alt="" srcset="">
                </div>
                <form action="{{ route('mobile.proses.login') }}" method="post">
                    @csrf
                    <div class="row mt-5">

                        <div class="input-field col s10 offset-s1">
                            <input id="email311" type="email" name="email" class="validate">
                    ...
                    @error('email')
                        <div class="text-center"
                            style="background-color: white; width:300px; margin:0 auto; border-radius:5px;">
                            <small style="color:red;" class="badge bg-danger">{{ $message }}</small>
                        </div>
                    @enderror
                ...
                <div class="links">
                    ...
                    <a href="/mobile/lupa-password">Lupa Password</a><span class="sep">|</span><a
                        href="/mobile/registrasi">Registrasi</a>
                </div>
