                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Mark Kost</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <form class="mb-3" action="{{ route('proses.pendaftaran') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="no_tlp" name="no_tlp"
                                    placeholder="No Telp" value="{{ old('no_tlp') }}" />
                                @error('no_tlp')
                                    <span style="color:red;font-size:13px;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="dok_ktp" class="form-label">Dokumen KTP</label>
                                <input type="file" class="form-control" name="dok_ktp" id="dok_ktp"
                                    placeholder="Dokumen KTP" />
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select" name="level" id="level">
                                    ...
                                    <option value="pemilik_kost"
                                        {{ old('level') == 'pemilik_kost' ? 'selected' : '' }}>Pemilik Kost</option>
